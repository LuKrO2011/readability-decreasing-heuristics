...
public class RDElementPrinterHelper {
    private final RDJavaPrettyPrinter prettyPrinter;
    private final Environment env;
    private TokenWriter printer;

    public RDElementPrinterHelper(TokenWriter printerTokenWriter, RDJavaPrettyPrinter prettyPrinter, Environment env) {
     ...
     */
    /*protected void printPermits(RDCtSealable sealable) {
