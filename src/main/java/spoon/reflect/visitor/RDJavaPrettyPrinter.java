 ...
 */
public class RDJavaPrettyPrinter implements CtVisitor, PrettyPrinter {
     ...
     */
    public RDJavaPrettyPrinter(Environment env) {
        this.env = env;
     ...
     */
    public RDJavaPrettyPrinter setLineSeparator(String lineSeparator) {
     ...
     */
    public RDJavaPrettyPrinter scan(CtElement e) {
        if (e != null) {
            enter(e);
    ...
    /**
     * @return current {@link TokenWriter}, so the subclasses of {@link RDJavaPrettyPrinter} can print tokens too
     */
     ...
     */
    public RDJavaPrettyPrinter setPrinterTokenWriter(TokenWriter tokenWriter) {
        // elementPrinterHelper = new RDElementPrinterHelper(tokenWriter, this, env);
        printer = tokenWriter;
        return this;
    }
